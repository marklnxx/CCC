                ...
                if (isset($_GET["cubierta_id"]) && $_GET["cubierta_id"] != "") {
                    ...
                    if ($result_nombre_cubierta->num_rows > 0) {
                        ...
                        if (empty($registros_historial) && !empty($reconstrucciones)) {
                            ...
                            foreach ($registros_historial as $registro) {
                                // Calcular kilómetros recorridos si hay datos disponibles
                                $km_recorridos = '';
                                ...
                                echo "<td>" . ($registro["fecha_retiro"] ?: 'En uso') . "</td>";
                                echo "<td>" . number_format($registro["kilometraje_colocacion"], 0, ',', '.') . " km</td>";
                                echo "<td>" . ($registro["kilometraje_retiro"] ? number_format($registro["kilometraje_retiro"], 0, ',', '.') . " km" : 'En uso') . "</td>";
